...
public class MasterCreditDto {
    ...
    public MasterCreditDto(String transactionType, long cardNumber, String expirationDate, String customerName, String customerPhone, int cvvNumber, String transactionDate, long accountNumber, double value, String currency,String integrityCheck,long phaseBit,String keyId) {
